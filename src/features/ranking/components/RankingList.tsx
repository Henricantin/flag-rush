		...
		<>
			<div className="grid gap-2">
				...
				<button
					...
					className="mt-1 rounded-xl border border-fuchsia-400/20 bg-fuchsia-400/5 px-4 py-2.5 text-sm font-semibold text-fuchsia-300 transition hover:bg-fuchsia-400/10"
				>
					Ranking completo
				</button>
			</div>
